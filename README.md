...
```python
digit_50 = '''37107287533902102798797998220837590246510135740250
...
digit_50 = digit_50.split('\n')
digit_50 = map(int,digit_50)
...
for i in range(1,1*10**6):
    seq,len_seq = collatz_sequence(i)
    if len_seq > longest_seq:
        longest_seq = len_seq
        longest_list = seq
print(longest_list,longest_seq)
...
![2x2 Grid](https://projecteuler.net/project/images/p015.png)
